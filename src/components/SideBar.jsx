...
export const SideBar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`absolute top-0 left-0 w-64 h-screen transition-transform z-40 ${
          isOpen ? "translate-x-0" : "-translate-x-full sm:translate-x-0"
        }`}
      >
        <div className="h-full px-3 py-4 overflow-y-auto  bg-gradient-to-b from-blue-900 to-transparent">
